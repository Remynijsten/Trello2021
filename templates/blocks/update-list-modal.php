<div class="update-list-modal lists-modal modal d-none">
    ...
    <div class="modal_body animate__animated animate__bounceInUp">
        ...
        <div class="modal_body_content">
            ...
            <div class="row">
                ...
                <div class="col-4"><button class="remove-list-button">Remove list</button></div>
                <div class="col-4"><button class="update-list-button">Update list</button></div>
            </div>
        </div>           
    </div>
</div>