<div class="update-task-modal tasks-modal modal d-none">
    ...
    <div class="modal_body animate__animated animate__bounceInUp">
        ...
        <div class="modal_body_content">
            ...
            <div class="row">
                ...
                <div class="col-4"><button class="remove remove-task">Remove Task</button></div>
                <div class="col-4"><button class="update update-task">Update Task</button></div>
            </div>
        </div>
    </div>
</div>